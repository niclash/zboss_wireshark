...
/* Enable or disable ZigBee Green Power Profile */
#define ZBEE_GREEN_POWER_ENABLED
...
#define ZBEE_VERSION_GREEN_POWER    3 /* Green power device */
...
#define ZBEE_PROTOABBREV_NWK_GP "zbee_green_power"
